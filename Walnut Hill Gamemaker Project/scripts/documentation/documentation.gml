function getDocumentation()
{
	...
	fixed = [
		...
		" - Followers can position during cutscenes",
		" - [NOT GONNA DO] Battle starts as a cutscene with dialogue and Sequence",
		" - Add FUNCTIONALITY to ATTACK",
		" - [NOT GONNA DO]Change battle box text based on battle flow or randomize values",
		" - Soul can shoot bullets!",
		" - Soul can shoot in different directions",
		" - BULLET PATTERNS!!!", 
		" - Battle start has soul splitting in half",
		" - Bullet Pattern - Circle",
		" - Bullet Pattern - Cross",
		" - Bullet Pattern - Random",
		" - Bullet Pattern - Random Burst (Left, Right, Up)",
		" - Bullet Pattern - Straight",
		" - Bullet Pattern - Sequence",
		" - Bullet Pattern - Sequence + Random Bullets",
		" - Bullet Pattern - Large Horizontal Random Bullets",
		" - Bullet Pattern - Large Vertical Random Bullets",
	...
	todos = [
		"","************************* TODOS *************************",
		" - [HOLD][NEED] Add in Sequence Support with Cutscene System",
